...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 group flex items-center gap-3 pl-3 pr-5 py-3 rounded-full bg-[#25D366] text-white shadow-[0_15px_40px_-15px_rgba(37,211,102,.55)] transition-all duration-500 ease-cinema hover:scale-[1.04]"
    >
